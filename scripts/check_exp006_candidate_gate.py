...
from model_forensics.certification import evaluate_exp006_candidate_gate
from model_forensics.config import load_experiment_config


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Check the frozen Experiment 006 clean/candidate behavioral gates."
    )
...
def main() -> None:
    ...
    if config.experiment_id != "exp006":
        raise ValueError("candidate gate requires Experiment 006 config")
