...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run blinded Experiment 001 RCA baselines.")
    parser.add_argument(
        "--diagnostic-manifest",
        default="artifacts/exp001/prepared/lineage/diagnostic.json",
    )
    parser.add_argument("--prepared", default="artifacts/exp001/prepared")
    parser.add_argument(
        "--baseline-generations",
        default="artifacts/exp001/runs/baseline/generations/target.jsonl",
    )
    parser.add_argument(
        "--candidate-generations",
        default="artifacts/exp001/runs/candidate/generations/target.jsonl",
    )
    parser.add_argument(
        "--output-root",
