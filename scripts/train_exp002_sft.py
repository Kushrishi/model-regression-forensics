...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train one Experiment 002 LoRA SFT sibling run.")
    ...
    parser.add_argument("--output-root", default="artifacts/exp002/checkpoints")
