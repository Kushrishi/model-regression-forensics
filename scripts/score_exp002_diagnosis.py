...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Score frozen Experiment 002 RCA rankings.")
    parser.add_argument(
        "--benchmark-manifest",
        default="artifacts/exp002/prepared/lineage/benchmark.json",
    )
    parser.add_argument(
        "--diagnosis-root",
        default="experiments/002_entangled_distractors/diagnosis",
    )
    parser.add_argument("--output", default="artifacts/exp002/diagnosis_scores.json")
...
def main() -> None:
    ...
    methods = ("random", "lexical_overlap", "changed_lexical_overlap")
    scores = {
